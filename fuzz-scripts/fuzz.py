...
from pcapParse.tree2message import Serializer, fill_session
...
def main(target_info):
    ...
    login_packs = target_info['login_packs']
    main_packs = target_info['main_packs']
    # netmon_port = target_info[26001]
    # procmon_port = target_info[26002]
