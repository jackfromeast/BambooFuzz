...
class ProcessMonitorPedrpcServer(pedrpc.Server):
    def __init__(
        ...
        self.crash_bin = crash_binning.CrashBinning()
    ...
    def start_target(self):
        ...
        self.debugger_thread.start() # 开始线程活动，在另一新线程中执行run()函数内容
    ...
    ### lzy 3.20
    def set_cwd_path(self, new_cwd_path):
        self.log("updating shell path to: {0}".format(list(new_cwd_path)))
        self.cwd_path = new_cwd_path
